...
describe('ConfigReader', () => {
    ...
    describe('Constructor', () => {
        it('should initialize with default options', () => {
            ...
            expect(reader.getConfigPath()).toContain(path.join('.config', 'full-self-coding', 'config.json'));
        });
        ...
        it('should initialize with custom config filename', () => {
            ...
            expect(reader.getConfigPath()).toContain(path.join('.config', 'full-self-coding', 'custom.json'));
        });
