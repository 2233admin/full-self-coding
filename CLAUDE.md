...
This project is indexed by GitNexus as **full-self-coding** (381 symbols, 975 relationships, 28 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
